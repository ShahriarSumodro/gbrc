    ...
    <section className="relative min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 container mx-auto px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-foreground/90 mb-8 leading-relaxed">
          We're a student-led group dedicated to building innovative robots.
          Our team consists of engineers and makers who transform ideas into working machines.
          From combat robots to autonomous systems, we push boundaries through hands-on learning.
        </p>
